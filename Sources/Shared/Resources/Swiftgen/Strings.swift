...
public enum L10n {
  ...
  public enum Extensions {
    public enum Map {
      ...
      public enum PayloadMissingHomeassistant {
        /// Payload didn't contain a clesyde dictionary!
  ...
  public enum HaApi {
    public enum ApiError {
      ...
      /// Received invalid response from Clesyde
      ...
      /// The mobile_app component is not loaded. Please add it to your configuration, restart Clesyde, and try again.
      ...
      /// Your Clesyde version (%@) is too old, you must upgrade to at least version %@ to use the app.
  ...
  public enum Nfc {
    ...
    public enum List {
      ...
      /// 
      /// Tags will work on any device with Clesyde installed which has hardware support to read them.
    ...
    public enum Action {
      public enum Rows {
        public enum AuthenticationRequired {
          /// When the user selects an action with this option, the system prompts the user to unlock the device. After unlocking, Clesyde will be notified of the selected action.
  ...
  public enum Onboarding {
    ...
    public enum ManualSetup {
      ...
      /// The URL of your Clesyde server. Make sure it includes the protocol and port.
    ...
    public enum Permissions {
      ...
      public enum Focus {
        /// Allow whether you are in focus mode to be sent to Clesyde
      ...
      public enum Motion {
        /// Allow motion activity and pedometer data to be sent to Clesyde
      ...
      public enum Notification {
        /// Allow push notifications to be sent from your Clesyde
    ...
    public enum Welcome {
      /// This app connects to your Clesyde server and allows integrating data about you and your phone.
      /// 
      /// Clesyde is free and open source home automation software with a focus on local control and privacy.
  ...
  public enum Settings {
    public enum ConnectionSection {
      ...
      /// Directly connect to the Clesyde server for push notifications when on internal SSIDs.
    ...
    public enum ResetSection {
      public enum ResetAlert {
        /// Your settings will be reset and this device will be unregistered from push notifications as well as removed from your Clesyde configuration.
  ...
  public enum SettingsDetails {
    ...
    public enum Privacy {
      ...
      public enum Analytics {
        /// Allows collection of basic information about your device and interactions with the app. No user identifiable data is shared, including your Clesyde URLs and tokens. You must restart the app for changes to this setting to take effect.
  ...
  public enum UrlHandler {
    ...
    public enum XCallbackUrl {
      public enum Error {
        ...
        /// service (e.g. clesyde.turn_on) must be defined
  ...
  public enum Widgets {
    ...
    public enum OpenPage {
      /// Open a frontend page in Clesyde.
