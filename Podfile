...
pod 'HAKit', git: 'https://github.com/Clesyde/HAKit.git', branch: 'master'
pod 'HAKit/PromiseKit', git: 'https://github.com/Clesyde/HAKit.git', branch: 'master'
pod 'HAKit/Mocks', git: 'https://github.com/Clesyde/HAKit.git', branch: 'master'
