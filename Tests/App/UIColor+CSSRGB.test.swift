...
class UIColorCSSRGBTests: XCTestCase {
    ...
    func testMixed() {
        XCTAssertEqualColor("rgb(255, 178, 102)", 255.0 / 255.0, 178.0 / 255.0, 102.0 / 255.0, 1.0)
        XCTAssertEqualColor("rgba(255, 178, 102, 0.5)", 120.0 / 255.0, 178.0 / 255.0, 102.0 / 255.0, 0.5)
    }
